        ...
        <div class="col">
          <div class="card border border-info h-100 d-flex flex-column">
            ...
            <div class="ratio ratio-16x9 overflow-hidden">
              <img
                src="../asset/uploads/<?= htmlspecialchars($row['gambar_projek']); ?>"
            ...
            <div class="card-body d-flex flex-column">
              ...
              <div class="mt-auto">
                <div class="d-flex justify-content-center gap-2 mb-2">
                  <a
                    href="edit_projek.php?projek_id=<?= $row['projek_id']; ?>"
                  ...
                  <a
                    href="hapus_projek.php?projek_id=<?= $row['projek_id']; ?>"
                ...
                <a
                  href="lihat_projek_saya.php?projek_id=<?= $row['projek_id']; ?>"
