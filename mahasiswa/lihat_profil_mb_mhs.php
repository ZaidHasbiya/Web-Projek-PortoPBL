...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark py-3 bg-dark-blue shadow">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ms-auto d-flex gap-3 text-center pt-lg-0 pt-4">
          <li class="nav-item">
            <a class="nav-link fw-bold" href="index_mahasiswa.html">Beranda</a>
          </li>
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item" href="lihat_profil_mb_mhs.html">Profil Saya</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link fw-bold" href="../login.html">Logout</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="row align-items-center">
    ...
    <div class="col-md-4 text-center">
      ...
      <div class="bg-info p-2 rounded d-inline-block bg-dark-blue">
        <strong class="text-white">Jurusan: Manajemen Bisnis</strong>
      </div>
    </div>
    ...
    <div class="col-md-8 ">
      <!-- Tentang Mahasiswa -->
      <div class="bg-info p-3 rounded mb-4 bg-dark-blue">
      ...
      <!-- Catatan Prestasi -->
      <div class="bg-info p-3 rounded bg-dark-blue">
...
<div class="bg-info p-4 rounded mt-4 bg-dark-blue">
