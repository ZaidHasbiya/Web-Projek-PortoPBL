...
$query = "SELECT * FROM users WHERE jurusan = 'manajemen bisnis'";
...
<body>
  ...
  <div class="container">
    <h1 class="my-5">Jurusan Manajemen Bisnis</h1>
      ...
      <div class="col-md-4 col-lg-3">
        <div class="card shadow-sm border-0 h-100">
          ...
          <div class="card-body text-center">
            ...
            <a href="lihat_profil_mb_mhs.php?id=<?= $row['id']; ?>" class="btn btn-info px-4">Lihat Profil</a>
          </div>
        </div>
      </div>
      <?php endwhile;?>
