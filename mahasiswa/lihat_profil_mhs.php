...
<<<<<<< HEAD
    header("Location: lihat_profil_mhs.php");
    exit;
}
...
<<<<<<< HEAD
    <?php else: ?>
        <p class="text-center fw-semibold">Mahasiswa belum mengunggah projek apapun.</p>
    <?php endif; ?>
