...
// Fungsi pembantu untuk menyimpan data SweetAlert ke session
...
// Cek apakah parameter ID ada di URL
    ...
    // Query hapus data dosen berdasarkan ID (Pastikan role adalah dosen)
    $hapus = mysqli_query($koneksi, "DELETE FROM users WHERE id='$id' AND role='dosen'");

    // Cek apakah query berhasil
    if($hapus){
        set_alert('success', 'Data dosen berhasil dihapus!', 'data_dosen.php');
    } else {
        set_alert('error', 'Gagal menghapus data', 'data_dosen.php');
    }
}
?>
...
<head>
    ...
    <title>Proses Hapus Dosen...</title>
