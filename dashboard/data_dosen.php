                    ...
                    <table class="table table-bordered text-center">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_dosen.php?id=<?= $row['id']; ?>" class="btn btn-warning btn-sm text-white"><i class="fas fa-edit"></i>Edit</a>
                                </td>
                                <td>
                            ...
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalLihatLabel<?= $row['id']; ?>">Detail Dosen
                                        </h5>
