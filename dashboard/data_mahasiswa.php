...
table thead tr { background-color: #f8f9fa; font-weight: 600; font-size: 15px; text-align: center; }
table tbody td { text-align: justify; vertical-align: top; }
</style>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <a href="tambah_mahasiswa.php" class="btn btn-info text-white mb-4"><i class="fas fa-plus"></i> Tambah Mahasiswa</a>
                                ...
                                <?php if ($result > 0): 
                                    ...
                                    while($row = mysqli_fetch_assoc($data)): ?>
                                        <tr>
                                            ...
                                            <td><?= !empty($row['jurusan']) ? htmlspecialchars($row['jurusan']) : 'Belum diatur'; ?></td>
                                            <td>
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p><strong>Jurusan:</strong> <?= !empty($row['jurusan']) ? htmlspecialchars($row['jurusan']) : 'Belum diatur'; ?></p>
                                                    </div>
