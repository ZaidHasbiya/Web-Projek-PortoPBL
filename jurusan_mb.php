...
// Query untuk mengambil data mahasiswa Manajemen Bisnis
...
// Query untuk menghitung total mahasiswa Manajemen Bisnis
...
<body>
    ...
    <div class="container">
        ...
        <!-- Judul halaman -->
        <h1 class="my-5 pt-5 text-center">Jurusan Manajemen Bisnis</h1>
            ...
            <div class="col-md-4 col-lg-3">
                <div class="card shadow-sm border-0 h-100">
                    ...
                    <div class="card-body text-center">
                        <p class="mb-1"><strong>Nama:
                            </strong> <?= $row['nama']; ?>
                        </p>
                        <p class="mb-1">
                            <strong>NIM:< /strong> <?= $row['username']; ?>
                        </p>
                        <p class="mb-3"><strong>Jurusan:
                            </strong> <?= $row['jurusan']; ?>
                        </p>
